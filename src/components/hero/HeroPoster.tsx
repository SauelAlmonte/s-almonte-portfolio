...
export function HeroPoster({ className }: { className?: string }) {
  return (
    <div
      aria-hidden
      className={cn(
        "absolute inset-0 bg-[radial-gradient(42%_46%_at_50%_46%,rgba(179,156,208,0.16),transparent_70%),radial-gradient(30%_34%_at_56%_42%,rgba(168,218,220,0.10),transparent_70%)] lg:bg-[radial-gradient(34%_52%_at_72%_50%,rgba(179,156,208,0.16),transparent_70%),radial-gradient(24%_38%_at_76%_44%,rgba(168,218,220,0.10),transparent_70%)]",
        className,
      )}
    />
  );
