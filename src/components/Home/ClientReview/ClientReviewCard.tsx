    ...
    return (
        <article
            className="mt-2 rounded-2xl border border-cyan-400/30 bg-white/5 backdrop-blur-md p-6
                 ...
                 hover:border-cyan-300 hover:bg-cyan-300/10 m-2"
        >
            <Image
                ...
                height={60}
            />
            <div className="flex flex-col gap-1 mt-2 text-left py-1">
                <h3 className="text-base font-bold text-zinc-100">{name}</h3>
                <p className="text-sm italic font-semibold text-zinc-200">
                    {role}
                </p>
                <p className="mt-2 text-base text-zinc-300 font-medium">
                    &#8220;Lorem ipsum dolor sit amet consectetur adipisicing
                    elit. Numquam sint mollitia similique blanditiis nemo,
                    praesentium provident et a hic quam.&#8221;
                </p>
            </div>
        </article>
    );
