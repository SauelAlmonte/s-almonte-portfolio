...
type Props = {
    ...
    delay?: number;
    stagger?: number;
    /** Inherit animation from parent container (default) */
    controlledByParent?: boolean;
};

export default function ClientReviewHeading({
    id,
    className,
    delay = 0,
    stagger = 0.18,
    ...
    const base =
        className ??
        'text-center text-2xl md:text-3xl xl:text-4xl mt-4 pretty font-bold text-zinc-50';
