    ...
    return (
        ...
        >
            ...
            <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 items-center justify-center">
                ...
                {/* Right Card (Form) */}
                <div className="p-8">
                    <div className="p-8 h-full flex flex-col rounded-2xl border border-cyan-400/30 bg-white/5 backdrop-blur-md shadow-lg shadow-cyan-500/10 hover:shadow-cyan-400/20 transition duration-300 m-2 autofill-dark">
                        <form
