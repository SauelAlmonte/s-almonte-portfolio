...
const UnderConstruction = () => (
    ...
    >
        <div className="px-8 py-4 rounded-2xl bg-cyan-50 shadow-2xl border-2 border-cyan-300 z-30 drop-shadow-2xl">
            <span className="text-2xl sm:text-3xl font-bold text-zinc-700 z-50">
                Under Construction
            </span>
        </div>
    </div>
